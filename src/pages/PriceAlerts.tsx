...
import { Product, PriceAlert as PriceAlertModel } from '../types';
import { formatPrice, formatDate } from '../utils/formatting';
import { Bell, Trash2, Plus } from 'lucide-react';

// Supabase row shape: price_alerts joined with products(*)
type PriceAlertRow = PriceAlertModel & {
  products?: Product;
};
...
export const PriceAlerts: React.FC = () => {
  ...
  if (!isAuthenticated) {
    // you can also show a nice message, but redirect keeps it simple
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({ ...prev, targetPrice: e.target.value }))
                  }
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white"
